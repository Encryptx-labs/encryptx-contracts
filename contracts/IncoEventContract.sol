...
contract IncoEventContract is GatewayCaller, Ownable {
    ...
    function setInterchainSecurityModule()
        public
        onlyContractOrNull(0xdDB9F3da750caEd4703C94b8E024ccBC5017bC97)
        onlyOwner
    {
        interchainSecurityModule = IInterchainSecurityModule(0xdDB9F3da750caEd4703C94b8E024ccBC5017bC97);
    }
